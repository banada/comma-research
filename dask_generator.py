...
def concatenate_body(camera_names, time_len):
  ...
  return c5x, angle, filters, hdf5_camera
...
def datagen(filter_files, time_len=1, batch_size=256, ignore_goods=False):
  ...
  c5x, angle, filters, hdf5_camera = concatenate_body(filter_names, time_len=time_len)
